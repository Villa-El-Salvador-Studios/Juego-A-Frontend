 ...
 const InicioSesion = () => {
    ...
    return (
        <div>
            ...
            <LlenarInformacion textoH1="Usuario" textoInput="Usuario" tipo="text" onInputChange={onInputChange}/>
            <LlenarInformacion textoH1="Contraseña" textoInput="Contraseña" tipo="password" onInputChange={onInputChange} sources={sources}/>
            <br></br>
