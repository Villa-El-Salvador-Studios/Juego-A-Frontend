    ...
    const enviarInformacion = () => {
        ...
        JugadorService.Create(data)
            .then(response => {
                ...
                // Crear registro dejugadorHechizo
                for (let i = 1; i < 3; i++) {
                    jugadorHechizoData.jugadorId = response.data.id
                    jugadorHechizoData.hechizoId = i

                    JugadorHechizoService.Create(jugadorHechizoData)
                }
                ...
                for (let i = 1; i < 7; i++) {
                    ...
                    JugadorObjetoService.Create(jugadorObjetoData)
                }

                JugadorObjetoService.Create()
    ...
    <div className="espacio-registro">
        ...
        <div className="centrado">
            ...
            <LlenarInformacion
                ...
                onKeyDown={handleKeyPress}/>
            <LlenarInformacion
                textoH1="Repetir contraseña"
                textoInput="Repetir contraseña"
                onInputChange={onInputChange}
                tipo="password"
                sources={sources}
                onKeyDown={handleKeyPress}/>
